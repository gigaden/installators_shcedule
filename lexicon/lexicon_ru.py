LEXICON_RU = {
    ...
    '<i>- Скопируйте адрес из "Монтажника" и отправьте его в сообщении'
    "<u>(по одному адресу в каждом сообщении)</u></i>.\n"
...
LEXICON_ADDRESS = {
    ...
    "или добавьте адрес",
    "/add_scores": "Внесите баллы за день, прежняя запись не сохранится.",
    "scores_added": "Баллы за день добавлены.",
    "wrong_scores": "Баллы можно вводить в числовом формате,\n"
                    "Либо через точку, пример:\n"
                    "60\n"
                    "60.7",
}
...
LEXICON_CALENDAR = {
    ...
    "add_scores": "Добавить баллы",
}

LEXICON_EDIT_USER = {
    "edit": "Здесь можно отредактировать свои регистрационные данные.\n"
    "Нажмите на поле, которое нужно изменить: \n\n",
    "edit_field": 'Введите новые данные и нажмите "Отправить"\n',
    "fio": 'Введите ваше ФИО в формате - "Фамилия Имя Отчество"\n\n'
    "Пример:\n Иванов Иван Иванович\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "car_num": "Введите номер автомобиля\n\n"
    "Пример:\n Е001КХ199\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "car_model": "Введите марку автомобиля\n\n"
    "Пример:\n Mercedes-Benz\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "dogovor": "Введите номер договора\n\n"
    "Пример:\n 0605/25/2121/21 от 22.09.2021 г.\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "filial": "Введите региональный филиал\n\n"
    "Пример:\nНижегородский\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "filial_address": "Введите адрес филиала\n\n"
    "Пример:\nНижний Новгород, ул. Космонавта Комарова, 13Б\n\n"
    'Для выхода нажмите "Закрыть"\n',
    "score_price": "Введите стоимость балла\n\n"
    "Необходимо для расчёта вашего дохода за день и месяц в разделе 'Статистика'"
}
