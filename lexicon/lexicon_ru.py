...
LEXICON_ADDRESS = {
    ...
    'addresses_added': 'Адрес добавлен\nчтобы добавить ещё один вставьте его и отправьте\n'
                       'чтобы сохранить адреса и выйти нажмите "Сохранить адреса"\n'
                       'чтобы выйти без сохранения нажмите "Закрыть"\n'
                       'чтобы добавить адрес филиала нажмите "Добавить адрес филиала"',
...
LEXICON_CALENDAR = {
    ...
    'not_enough_addresses': 'За день должно быть добавлено минимум два адреса, чтобы рассчитать пробег \n'
